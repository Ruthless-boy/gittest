...
public class JspUtil {
    ...
    public static void main(String[] args) {
        try {
            Context context = new Context("/javaweb", "/Users/ruthless/Downloads/大三下/javaweb/web", null,true);
            File file = new File("/Users/ruthless/Downloads/大三下/javaweb/web/index.jsp");
